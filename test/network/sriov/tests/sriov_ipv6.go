...
var _ = Describe("CNF SRIOV", func() {
	...
	DescribeTable(
		...
		func(mtu int, protocol string, connectivity string) {
			netsriovhelper.TestSriovIPv6Scenario(mtu, protocol, connectivity, sriovInfos, Config, netsriovparameters.ClientMacAddress, netsriovparameters.ServerMacAddress)
		},
