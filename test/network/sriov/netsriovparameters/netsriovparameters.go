...
const (
	...
	SriovWhereaboutsNetworkUsualMTUName       = "test-sriov-whereabouts-usual"
	SriovWhereaboutsNetworkCustomMTUName      = "test-sriov-whereabouts-custom"
	SriovWhereaboutsNetworkJumboFrameName     = "test-sriov-whereabouts-jumbo"
	SriovWhereaboutsNetworkUsualMTUNameDiff   = "test-sriov-whereabouts-usual-diff"
	SriovWhereaboutsNetworkCustomMTUNameDiff  = "test-sriov-whereabouts-custom-diff"
	SriovWhereaboutsNetworkJumboFrameNameDiff = "test-sriov-whereabouts-jumbo-diff"
