...
var _ = Describe("MetalLB BGP", func() {
	...
	// 49837
	DescribeTable("Allow two specific pools to BGP Peers", polarion.ID("49837"),
		...
		Entry(describe, netparameters.IPV4Family, netmlbparameters.IBGPASN, netmlbparameters.ExtTrafPolLocal,
			...
			polarion.SetProperty("BGPASN", fmt.Sprintf("%d", netmlbparameters.IBGPASN))),
		...
		Entry(describe, netparameters.IPV4Family, netmlbparameters.EBGPASN, netmlbparameters.ExtTrafPolLocal,
			polarion.SetProperty("TrafficPolicy", netmlbparameters.ExtTrafPolLocal),
			polarion.SetProperty("IPStack", netparameters.IPV4Family),
			polarion.SetProperty("BGPASN", fmt.Sprintf("%d", netmlbparameters.EBGPASN))),
	...
	// 49838
	DescribeTable("Allow single pool to BGP Peers", polarion.ID("49838"),
		func(ipStack string, bgpASN int, trafficPolicy string) {
			netmetallbhelper.TestBGPPeerSpecificIPAddressPools(
				ipStack,
				trafficPolicy,
